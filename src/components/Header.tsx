...
const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
      isScrolled ? 'bg-blue-500 shadow-md py-2' : 'bg-transparent py-4'
    }`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <a href="https://app.multigym.com.ar/" className="text-gray-800 hover:text-blue-600 font-medium transition-colors">Registro</a>
        ...
        <div className="md:hidden bg-white shadow-lg">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex flex-col space-y-3">
              <a href="#home" className="text-gray-900 py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Inicio</a>
              <a href="#features" className="text-gray-900 py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Características</a>
              <a href="#register" className="text-gray-900 py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Registro</a>
              <a href="#download" className="text-gray-900 py-2 border-b border-gray-100" onClick={() => setIsMenuOpen(false)}>Descarga la App</a>
              <a href="#contact" className="text-gray-900 py-2" onClick={() => setIsMenuOpen(false)}>Contacto</a>
